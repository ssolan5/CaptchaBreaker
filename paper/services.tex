...
\note{Table with service overview: name, content type (alphanumeric, nato phonetic etc, length, 
level of noise (moderate, high, etc)).}
...
and we will differentiate between the 2 versions in the remainder of the paper. \jason{Does it include 0? Update table.}
