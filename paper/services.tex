...
differentiate between the 2 versions in the remainder of the paper. \jason{Does it include the digit 0? Update table.}
...
\note{Actions.} Google: If the web application is detecting bot behavior based upon time differences.
