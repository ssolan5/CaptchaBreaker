...
\protect\circlea{\small 4} The "transcript"ion of the audio challenge is obtained from the solver 
...
\emph{IBM Watson.} IBM Watson's Speech To Text service provides a public REST API, and the website provides 
