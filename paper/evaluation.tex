...
\rowcolor{Gray}
Telerik  & 21.2\% (142/670)  & \textbf{97\%} (452/466) & 12.9\% (47/364) & 74.2\% (150/202) & 49.3\% (112/217) \\
\bottomrule
\end{tabular}
...
that \re would adapt to the large amount of requests issued from our solver and return captchas with more digits. 
...
\hline
Recaptcha v2.a & 13.85s & 10.56s  & 12.25s & 18.46s & 20.41s \\
\rowcolor{Gray}
Recaptcha v2.b &  &  &  & & \\
Apple  & 36.4s & 33.4s  & 34.7s & 15.5s & 13.9s \\
\rowcolor{Gray}
BotDetect  & 5.53s  & 4.21s & 5.72s & 3.40s & 3.05s \\
Captchas.net  & 19.92s  & 14.62s  & 15.65s  & 7.56s & 7.79s \\
\rowcolor{Gray}
Microsoft Live & &  &  & & \\
SecurImage  & 34.31s & 23.60s & 25.10s  & 27.29s & 35.28s \\
\rowcolor{Gray}
Telerik  & & & & & \\
\bottomrule
\end{tabular}
