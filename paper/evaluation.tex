...
results for \note{X} of the captcha schemes. \note{Wit the best against Live, which is the one service that
doesn't have a limited dictionary. Also with doesn't allow you to limit the dictionary.}

While attackers could increase the attacks' accuracy
...
\rowcolor{Gray}
Microsoft Live & 14.37s  &  & 20.2  & 10.52s  & 9.07s \\
