...
In an independent concurrent study, Bock et al.~\cite{bock17uncaptcha} recently presented an attack against \re.
...
submit all the digits to \note{5} speech recognition services, and then construct the solution based on the output of 
