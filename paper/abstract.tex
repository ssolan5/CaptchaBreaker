...
bypassing audio captchas. Our experimental evaluation highlights the effectiveness of our 
approach as our \system system achieves a success rate of \note{X-Y\%}.
The implications of our study are twofold. First, the wide availability of advanced
speech recognition services have severely lowered the technical capabilities required by fraudsters
...
as we achieve a significantly higher attack accuracy against \re's audio challenges compared to 
recent state-of-the-art attacks against their image-based challenges. Overall, we argue the necessity 
of exploring alternative designs for captcha challenges that fulfill the accessibility properties 
of audio captchas without undermining the security currently offered by their visual counterparts.
