...
function findSimilarWords(word){
	...
	if(word=="hey" || word=="hay" || word=="a"){
		...
		value = "q";
	}else if(word=="more" || word=="or" || word=="are" || word=="r"){
		value = "r";
	}else if(word=="yes" || word=="s"){
		value = "s";
	}else if(word=="teams" || word=="team" || word=="tea" || word=="t"){
		value = "t";
        ...
        value = "3";
    }else if (word=="for" || word=="form"  || word =="full" || word=="four"){
        value = "4";
        ...
        value = "7";
    }else if (word=="hey" || word =="ate" || word=="at" || word=="eight" || word=="and"){
        value = "8";
