...
DownloadButton = None
withnoise_directory = "E:/ProjectResearch/Apple/WithNoise/IBMUS/CAPTCHA_SAVED/"
...
def downloadAndSolve():
    ...
    while solved != True:
        ...
        with open(r'E:/ProjectResearch/Apple/WithNoise/IBMUS/CAPTCHA_SAVED/' + filename + '.wav', 'ab') as fh:
        ...
        with open('E:/ProjectResearch/Apple/WithNoise/IBMUS/CAPTCHA_SAVED/' + filename + '.txt', 'r') as content_file:
        ...
        with open(r'E:/ProjectResearch/Apple/WithNoise/IBMUS/IBMWatsonUS.csv', 'a') as f:
