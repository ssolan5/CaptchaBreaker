...
DownloadButton = None
withnoise_directory = "E:/ProjectResearch/Apple/WithNoise/IBMUK/CAPTCHA_SAVED/"
...
def downloadAndSolve():
    ...
    while solved != True:
        ...
        with open(r'E:/ProjectResearch/Apple/WithNoise/IBMUK/CAPTCHA_SAVED/' + filename + '.wav', 'ab') as fh:
        ...
        # Solve the CAPTCHA
        accent = 'UK'
        success = execute_js('E:/ProjectResearch/Apple/index.js', withnoise_directory + filename + '.wav')
        success = execute_js('E:/ProjectResearch/Apple/gettranscription.js',
                          withnoise_directory + filename + '.txt')
        with open('E:/ProjectResearch/Apple/WithNoise/IBMUK/CAPTCHA_SAVED/' + filename + '.txt', 'r') as content_file:
        ...
        with open(r'E:/ProjectResearch/Apple/WithNoise/IBMUK/IBMWatsonUK.csv', 'a') as f:
...
while i<2:
    ...
    driver = webdriver.Chrome(executable_path="C:/Program Files/chromedriver_win32/chromedriver.exe",chrome_options=options)
    driver.get(url)
