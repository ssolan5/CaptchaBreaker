...
def replaceAlphaNum(x):
    ...
    if x == 'hey' or x == 'hay' or x == 'a':
        ...
        return 1
    elif x=='2' or x == 'two' or x == 'screw' or x == 'school' or x == 'scoop' or x =='scoops' or x =='to':
        return 2
    ...
    service_request = service.speech().syncrecognize(
        body={
            'config': {
                ...
                'speechContext': {
                        "phrases": [
                            "alpha","charlie","bravo","delta","echo","foxtrot","golf","hotel","india","juliett","kilo","lima","mike","november",
                            "oscar","papa","quebec","romeo","sierra","tango","uniform","victor","whiskey","x-ray","yankee","zulu","one","two","three",
                            "four","five","six","seven","eight","nine","ten",
                            "tree","sex","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"
                            "1","2","3","4","5","6","7","8","9"
                        ]
