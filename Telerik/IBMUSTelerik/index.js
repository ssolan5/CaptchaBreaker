...
function convertSpeechToText(){
	...
	var params = {
	  ...
	  max_alternatives: 3,
	  keywords: ['one', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'zero', 'alpha', 'bravo', 'charlie', 'delta', 'echo', 'foxtrot', 'golf', 'hotel', 'india', 'juliet', 'kilo', 'lima', 'mike', 'november', 'oscar', 'papa', 'quebec', 'romeo', 'sierra', 'tango', 'uniform', 'victor', 'whiskey', 'xray', 'yankee', 'zulu'],
	...
	recognizeStream.on('results', function(event) { onEvent('Results:', event); console.log(event);});
