...
function isAlphabet(){
	...
	if(arg!=null && arg.split(" ").length<3){
		...
		//"zero", "row", "one","won" ,"two", "to", "three", "tree", "four", "for", "five", "six", "seven", "eight", "nine" , 
		alphabets = ["a", "bee", "be",  "see", "sea", "de", "e",  "f", "g", "etch", "h", "i", "eye", "jay", "j", "k", "l" ,"am", "m", "n", "o", "pee", "p", "queue", "q", "are", "our", "r", "yes", "s", "tea", "t", "u", "you","ew", "we", "v", "double", "w", "ex", "x", "why", "y", "z"];
		if(arg.length>0){	
